...
object Handlingfailure extends App {
  ...
  def unsafeMethod(): String = throw new RuntimeException("NO STRING FOR YOU BUSTER-imbecil")
  ...
  * */
  ...
  object HttpService {
    ...
    def getConnection(host: String, port: String): Connection =
      ...
      else throw new RuntimeException("Someone-alguém else took-tomou the port")
  ...
  /*
    this is the equivalent logic in an imperative language
