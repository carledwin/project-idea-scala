...
object AllThePatterns extends App {
  ...
  //4- case classes - constuctor pattern
  ...
  /*
  It's with wrong
  val nameBindingMathc = aList match {
    case nonEmptyElement @ Cons(_,_) => //name binding => use the name later(here)
    case Cons(1, rest @ Cons(2, _)) => //name binding inside nested patterns
  }*/

  //8- multi-patterns
  /*val multipattern = aList match {
    case Empty | Case(0, _) => //compound-composto pattern (multi-pattern)
  }*/
  ...
  println(numberMatch) //returns 'a list of strings'
  //JVM trick-truque question
  // It's equivalent to:
